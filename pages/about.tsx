...
const About: NextPage = () => {
  return (
    <>
      ...
      <section className="flex flex-col-reverse space-y-8 space-y-reverse font-serif md:justify-between md:flex-row md:space-x-4 md:space-y-0">
        ...
        <img
          className="flex-none w-24 h-24 rounded-full sm:w-32 sm:h-32 md:w-48 md:h-48 filter drop-shadow-sm"
